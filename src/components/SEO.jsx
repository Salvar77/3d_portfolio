...
const SEO = () => {
  ...
  return (
    <Helmet>
      ...
      <meta property="og:description" content="Nowoczesne strony internetowe i sklepy e-commerce stworzone w React i Next.js - Opole. Szybkie, responsywne i zoptymalizowane pod SEO." />
      ...
      <meta name="twitter:description" content="Nowoczesne strony internetowe i sklepy e-commerce stworzone w React i Next.js - Opole. Szybkie, responsywne i zoptymalizowane pod SEO." />
